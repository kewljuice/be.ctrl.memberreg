    ...
    <section class="section">
        <div class="section__wrapper">
            <div class="section__content">
                <p>{ts}Please verify the information below carefully. Click
                        ...
                        <div class="display-block">
                            {if !$useForMember}
                                ...
                                {elseif $is_separate_payment }
                                    ...
                                    {elseif $amount }
                                        {ts}Amount{/ts}:
                                        <strong>{$amount|crmMoney} {if $amount_level }<span
                                                    class='crm-price-amount-label'> &ndash; {$amount_level}</span>{/if}
                                        </strong>
                                    {else}
                                        {$membership_name} {ts}Membership{/ts}:
                                        <strong>{$minimum_fee|crmMoney}</strong>
                            ...
                            {if $is_recur}
                                ...
                                {else}
                                    ...
                                    {else}
                                        ...
                                        {else}
                                            <p>
                                                <strong>{ts 1=$frequency_unit }I want to contribute this amount every %1.{/ts}</strong>
                                            </p>
                                        {/if}
                                    {/if}
